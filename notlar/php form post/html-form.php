...
Ad: <br>
<input type="text" readonly value="muhammet ali özbay" name="ad">
<hr>
Hakkımda: <br>
<textarea name="hakkımda" cols="50" placeholder="hakkında bir şeyler yaz.." rows="5"><?php echo post('hakkımda'); ?></textarea>
<hr>
Meslek: <br>
<select name="meslek">
    <option>-- seç --</option>
